TrainerDataPointers: ; 39d3b (e:5d3b)
	...
	dw AgathaData,LanceData,LumiData,JinxData,HaidenData,MochaData
	dw TronSilvumiData, MwahData, Lumi2Data, JonicData
...
Green3Data: ; 3a491 (e:6491)
	db $FF,50,DROWZEE,51,KITSARUSHI,63,JOLTEON,59,PIKACHU,51,REX_MASK,55,MEOWTH,0
	db $FF,67,ARCANINE,70,KITSUTO,65,PIKACHU,70,REX_PUMKIN,73,JOLTEON,70,DROWZEE,0
...
LumiData:
	db 18,VAPOREON,GLACEON,LAPRAS,0
	db $FF,46,VAPOREON,49,GLACEON,50,DEWGONG,47,LAPRAS,0
JinxData:
	db 16,GENGAR,GRIMER,0
HaidenData:
	db $FF,1,ZAPDOS,1,ARTICUNO,1,MOLTRES,1,MEW,1,MEWTWO,255,PIKACHU,0
MochaData:
	db $FF, 8, EEVEE, 7, EEVEE, 0
	db $FF, 11, EEVEE, 12, EEVEE, 10, EEVEE, 0
	db $FF, 20, JOLTEON, 21, FLAREON, 23, VAPOREON, 0
TronSilvumiData:
	db $FF, 22,GLACEON,21,DEWGONG,24,KADABRA,20,ALAKAZAM, 0
MwahData:
	db $FF, 4, JYNX, 6, JYNX, 0
	db $FF, 8, JYNX, 12, JYNX, 0
	db $FF, 12, JYNX, 18, JYNX, 0
	db $FF, 16, JYNX, 24, JYNX, 0
Lumi2Data:
	db $FF,61,VAPOREON,64,GLACEON,60,DEWGONG,71,LAPRAS,0
JonicData:
	db $FF, 71, PIKACHU	; jacob
	db 61, CHARIZARD
	db 63, PRIMEAPE
	db 64, VILEPLUME
	db 70, MAROWAK
