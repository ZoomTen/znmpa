MapSongBanks: ; throw all that shit away
	db Mus_PalletTown
	db Mus_Cities1
	db Mus_Cities1
	db Mus_Cities2
	...
	db Mus_SSAnne ;unused
	db Mus_SSAnne ;unused
	db Mus_PalletTown ; HallofFameRoom
	...
	db Mus_Vermillion ; VermilionHouse3
