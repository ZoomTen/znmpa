...
; Route6_Gate2_h map_id=$F8
ROUTE_6_GATE2_HEIGHT EQU $09
ROUTE_6_GATE2_WIDTH  EQU $1e

; Route6_LINK_h map_id=$F9
ROUTE_6_LINK_HEIGHT EQU 8
ROUTE_6_LINK_WIDTH  EQU 6
