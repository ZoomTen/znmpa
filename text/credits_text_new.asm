CreditsTextPointers: ; 742c3 (1d:42c3)
	...
	dw CredZnMPA_l3			; $43
	dw CredASMMod			; $44
	dw CredCustomSprites		; $45
	dw CredCustomMusic		; $46
	dw CredPokeredDisasm		; $47
	dw CredIIMarckus		; $48
	dw CredAndContributors		; $49
	dw CredOriginalCred1		; $4A
	dw CredOriginalCred2		; $4B
	dw CredNewScripts		; $4C
	dw CredContPlay_l1		; $4D
	dw CredContPlay_l2		; $4E
	dw CredContPlay_l3		; $4F
	dw CredContPlay_l0a		; $50
	dw CredContPlay_l0b		; $51
	dw CredBlank			; $52
	dw CredLumi			; $53
	dw CredIcedSnow			; $54
	dw CredJinx			; $55
...
CredJay:
	db -1, "JAY@"
CredTheta:
	db -8, "'THETA' CHARACTER@"
CredRLN:
	db -6, "REDLEOPARDNYRO@"
CredHaiden:
	db -8, "'HAIDEN' CHARACTER@"
CredHaidenisa:
	db -4, "HAIDENISA@"
CredFroggestSpirit:
	db -7, "FROGGESTSPIRIT@"
CredBlank:
	db 0, $50
CredZnMPA_l1:
	db -7, "ZILO AND MIXEL'S@"
CredZnMPA_l2:
	db -8, "#MON ADVENTURES@"
CredZnMPA_l3:
	db -3, "CREDITS@"
CredASMMod:
	db -8, "ASM MODIFICATIONS@"
CredNewScripts:
	db -5, "NEW SCRIPTS@"
CredContPlay_l0a:
	db -9, "Thank you for@"
CredContPlay_l0b:
	db -9, "playing!@"
CredContPlay_l1:
	db -9, "To continue the@"
CredContPlay_l2:
	db -9, "game, please reset@"
CredContPlay_l3:
	db -9, "your GAME BOY.@"
CredZoom:
	db -3, "ZOOMTEN@"
CredPokeredDisasm:
	db -8, "POKERED DISASSEMBLY@"
CredIIMarckus:
	db -4, "IIMARCKUS@"
CredAndContributors:
	db -7, "AND CONTRIBUTORS@"
CredCustomSprites:
	db -8, "CUSTOM SPRITES GFX@"
CredCustomMusic:
	db -4, "NEW MUSIC@"
CredOriginalCred1:
	db -6, "ORIGINAL GAME@"
