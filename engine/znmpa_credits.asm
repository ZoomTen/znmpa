...
Credits_DistortScreen1:
	...
	ld b, 7		; how many tiles to run this for?
...
.do2rows
	...
	ld a, [wCreditsScroll1]
	ld [rSCY], a
	inc d				; positive direction
	call Credits_CheckScanLine
	ld a, [wCreditsScroll1]
	cpl				; negative direction
	ld [rSCY], a
	inc d
	dec b
	jr nz, .do2rows			; jump if not done
	pop bc
	dec b
	jr nz, .do8pixels
.done
	xor a
	ld [rSCY], a			; return SCY to its place
	ret
...
Credits_Table_Begin:
	...
	db 4,8,12,16,20,24
	db 20,20,16,16
	db 12,12,12,12,8,8,8,8,4,4,4,4,2,2,2,2
...
; GREETS GO TO SOME RANDOM PERSON I KNOW FROM SOME GAMEBOY COMMUNITY XDDDDDD!!!!
	db "                "
	db "                "
	db "... Zilo and Mixel's Pokémon Adventures Credits ... "
	db "Pokered disassembly by IIMarckus and contributors ... "
	db "Assembly modifications by ZoomTen ... "
	db "New sprites and GFX by ZoomTen ... "
	...
	db "Kitsarushi, Rex Mask and their respective evolutions owned by RedLeopardNyro. Used with permission ... "
	db "Lumi and Mocha characters owned by Rae. Used with permission ... "
	db "Jinx character owned by Jay ... "
	db "Theta and Mwah characters owned by RedLeopardNyro. Used with permission ... "
	db "Haiden character owned by Haidenisa. Used with permission ... "
	db "                "
